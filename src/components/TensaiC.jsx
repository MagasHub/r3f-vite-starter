...
export function TensaiC(props) {
  const [uploadedImage, setUploadedImage] = useState(null);
  const { nodes, materials } = useGLTF('/models/tensaiC.glb');
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group position={[0.003, 0.189, 0.048]} rotation={[Math.PI / 2, 0, Math.PI / 2]} scale={0.001}>
        <mesh geometry={nodes['5025001-01001'].geometry} material={materials.print} position={[336.844, 0, 252.087]} rotation={[0, 0, -Math.PI / 2]} />
      </group>
      <mesh geometry={nodes.Cube.geometry} position={[0.001, -0.059, 0.329]} rotation={[Math.PI / 2, 0, 0]} scale={[0.9, 0.058, 0.399]} >
      ...
      <meshBasicMaterial transparent opacity={0}/>
        <Decal
          ...
          scale={[2, 2, 2]} // Scale of the decal
          uvScale={[1, 1]} // Initialize UV scale to 1, 1
          material-meshStandardMaterial-uv2needsUpdate
        >
...
useGLTF.preload('/models/tensaiC.glb')
