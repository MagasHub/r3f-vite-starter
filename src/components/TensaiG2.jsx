...
export function TensaiG(props) {
    ...
    <group {...props} dispose={null}>
      <group position={[0.003, 0.189, 0.048]} rotation={[Math.PI / 2, 0, Math.PI / 2]} scale={0.001}>
        ...
        <group position={[-18.656, 899.5, 252.087]}>
          <mesh geometry={nodes.faceEsquerda_1.geometry} material={materials.black} />
        ...
        <group position={[-18.656, -899.5, 306.337]} rotation={[0, 0, Math.PI]}>
          <mesh geometry={nodes.grelhaDireita_1.geometry} material={materials.black} />
  ...
  <meshStandardMaterial map={texture} />
      ...
      <group position={[0.004, -0.005, 0.06]} rotation={[Math.PI, 0, Math.PI]}>
        <mesh geometry={nodes.Cube002.geometry} material={materials.lotimain} />
