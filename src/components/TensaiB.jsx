...
Command: npx gltfjsx@6.2.16 public/models/tensai.glb -o src/components/Tensai.jsx -r public 
*/
...
export function TensaiB(props) {
  const [uploadedImage, setUploadedImage] = useState(null);
  const { nodes, materials } = useGLTF('/models/tensaiB.glb');
    ...
    <group {...props} dispose={null}>
      ...
      <group position={[0.003, 0.189, 0.048]} rotation={[Math.PI / 2, 0, Math.PI / 2]} scale={0.001}>
        ...
        <Decal
          ...
          scale={[200, 200, 200]} // Scale of the decal
...
useGLTF.preload('/models/tensaiB.glb')
