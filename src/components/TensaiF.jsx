...
export function TensaiF(props) {
  ...
  useEffect(() => {
    if (texture && texture.image) {
      ...
      texture.repeat.set(1 / aspect, 1); // Fit height
  ...
  return (
    <group {...props} dispose={null}>
      <group position={[0.003, 0.189, 0.048]} rotation={[Math.PI / 2, 0, Math.PI / 2]} scale={0.001}>
        ...
        <mesh geometry={nodes.logoDireita.geometry} material={materials.LOTIlogomain} position={[72.154, -900.161, 41.691]} rotation={[Math.PI / 2, 0, -Math.PI]} scale={1000} />
        <mesh geometry={nodes.logoEsquerda.geometry} material={materials.LOTIlogomain} position={[-98.518, 901.601, 41.692]} rotation={[-Math.PI / 2, 0, 0]} scale={1000} />
        <mesh geometry={nodes.logoFrente.geometry} material={materials.LOTIlogomain} position={[337.595, -655.821, -69.151]} rotation={[-Math.PI / 2, Math.PI / 2, 0]} scale={1000} />
        ...
        <mesh geometry={nodes.faceEsquerda.geometry} material={materials.lotimaterial} position={[-18.656, 899.5, 252.087]} />
        <group position={[336.844, 0, 252.087]} rotation={[0, 0, -Math.PI / 2]}>
          <mesh geometry={nodes.faceFrente_1.geometry} meshBasicMaterial transparent opacity={0} />
        ...
        <mesh geometry={nodes.faceTras.geometry} meshBasicMaterial transparent opacity={0} position={[-374.156, 0.41, 252.087]} rotation={[0, 0, Math.PI / 2]} />
        <mesh geometry={nodes.grelhaDireita.geometry} material={materials.lotimaterial} position={[-18.656, -899.5, 306.337]} rotation={[0, 0, Math.PI]} />
      ...
      <mesh geometry={nodes.FrontPanel.geometry} > < meshStandardMaterial map={texture}/></mesh>
      <mesh geometry={nodes.BackPanel.geometry} material={materials.lotiback} position={[0.004, -0.007, 0.061]} rotation={[-Math.PI, 0, -Math.PI]} />
      <Html>        <input type="file" accept="image/*" onChange={handleImageUpload} />
          </Html>
    </group>
  )
}
useGLTF.preload('/models/loti3d.glb')
