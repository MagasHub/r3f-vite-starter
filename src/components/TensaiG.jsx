...
export function TensaiG({ currentMaterial, setCurrentMaterialP, setCurrentMaterialB,currentMaterialS, setCurrentMaterialT,currentMaterialT, isImageActive, setIsImageActive, isImageActiveB, setIsImageActiveB, currentMaterialP, currentMaterialB, ...props }) {
  ...
  const { nodes, materials } = useGLTF('/models/loti.glb');
  ...
  return (
    <group {...props} dispose={null}>
      <group position={[0.003, 0.189, 0.048]} rotation={[Math.PI / 2, 0, Math.PI / 2]} scale={0.001}>
        ...
        <mesh geometry={nodes.logoFrente.geometry} material={materials.LOTIlogomain} position={[339.595, -655.821, -69.151]} rotation={[-Math.PI / 2, Math.PI / 2, 0]} scale={1000} />
        <group position={[-18.656, 155.938, -196.292]} rotation={[0, 0, Math.PI / 2]}>
          <group position={[-155.938, 0, 38.263]} rotation={[0, Math.PI / 2, 0]}>
            <mesh geometry={nodes.bordaDireita.geometry}><primitive object={(currentMaterialT || materials.polystyrene).clone()} attach="material" />
            position={[0, 0, -872]} rotation={[Math.PI / 2, 0, 0]} </mesh>
            ...
            <group position={[0, 0, -648]} rotation={[-Math.PI / 2, -Math.PI / 2, 0]}>
              ...
              <mesh geometry={nodes.bordaExtra_1.geometry}> 
